#!/usr/bin/env python3
"""
CLI script to list recordings for a Google Meet space.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description='List recordings for a Google Meet space'
    )
    parser.add_argument(
        '--space-name',
        type=str,
    ...
    try:
        ...
        result = service.list_recordings(args.space_name)
